                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" id="mask_number" class="form-control" name="nik" value="<?= $orang['nik']; ?>" required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="nama" value="<?= $orang['nama']; ?>" required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="phone" value="<?= $orang['phone']; ?>" required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="radio-list">
                                                    <label>
                                                        <input type="radio" name="gender" value="L" data-title="Laki-laki" <?php if ($orang['gender'] == "L"): ?>
                                                          checked="L"
                                                        <?php endif; ?> required/> Laki-laki </label>
                                                    <label>
                                                        <input type="radio" name="gender" value="P" data-title="Perempuan" <?php if ($orang['gender'] == "P"): ?>
                                                          checked="P"
                                                        <?php endif; ?> required/> Perempuan </label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="alamat" value="<?= $orang['alamat']; ?>" required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="kecamatan" value="<?= $orang['kecamatan']; ?>" required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <textarea class="form-control" rows="3" name="catatan"><?= $orang['catatan']; ?></textarea>
